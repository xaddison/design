...
import {_responsivePaddingStyle, _ResponsivePaddingStyleProps} from '../../styles'
...
const Root = styled(Layer)<ResponsiveDialogPositionStyleProps & _ResponsivePaddingStyleProps>(
